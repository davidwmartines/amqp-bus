...
const rpcBind = require('./rpc-bind');
...
/**
 * Listens and replies to remote-procedure-call (RPC) requests.
 * @param  {object} messageType The message type to receive.
 * @param  {function} handler   Callback function to handle incoming messages. Should resolve/return a value.
 * @return {promise}            Promise to resolve response message.
 */
Bus.prototype.bind =  function (messageType, handler) {
  return rpcBind(this, messageType, handler);
};
